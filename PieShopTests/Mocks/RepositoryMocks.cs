    ...
    public class RepositoryMocks
    {
        public static Mock<IPieRepository> GetPieRepository()
        {
            ...
            mock.Setup(repo => repo.GetByIdAsync(It.IsAny<int>()))
                .ReturnsAsync((int id) => pies.FirstOrDefault(p => p.PieId == id));

            mock.Setup(repo => repo.GetByCategoryAsync(It.IsAny<string>()))
                .ReturnsAsync((string cat) =>
                    pies.Where(p => p.Category?.CategoryName?.Equals(cat?.Trim(),
